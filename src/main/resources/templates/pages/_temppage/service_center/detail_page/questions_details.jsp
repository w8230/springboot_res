...
<div class="w1100">
	...
	<div class="view p-b-110">
		<input type="hidden" id="no" value="${questions_details.NO}">
		<div class="header">
			<div class="sub_title_wrap">
				<h3 class="sub_title m-b-10">${questions_details.TITLE}</h3>
			</div>
			<div class="sub_contents gary">
				<div class="sub_contents_txt">
					<i class="fas fa-user"></i>&nbsp;${questions_details.NICKNAME}&nbsp;
					<i class="far fa-calendar-alt"></i>&nbsp;${questions_details.WRITE_DATE}&nbsp;
					<i class="far fa-eye"></i>&nbsp;${questions_details.VIEWS}&nbsp;
				</div>
			</div>
			
			<div class="modify_delete_btn">
				<a class="modify_btn" href="questions_modify_page?NO=${questions_details.NO}">수정</a>
				<a class="delete_btn" onclick="questions_delete()">삭제</a>
			</div>
		</div>
		<div class="viewbody gary">
			<h6>
				${questions_details.CONTENTS}
				안녕하세요.<br>
