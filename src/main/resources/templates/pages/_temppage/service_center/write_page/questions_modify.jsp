	...
	<div id="contents" class="container">
		<div class="">
			<div class="tit-wrap m-b-55">
				...
				<h3 class="tit-split">자주하는 질문 수정</h3>
			</div>
    		
			<form action="questions_modify" method="post">
				...
				<input type="hidden" name="NO" value="${questions_details.NO}">
				<table class="table-list">
					<tbody class="table-body">
						<tr class="table-row">
							<td class="table-col">
								<span class="input-wrap">
									<input type="text" name="TITLE" id="title" placeholder="제목을 입력해주세요." value="${questions_details.TITLE}">
								</span>
							</td>
						</tr>
						<tr class="table-row">
							<td class="table-col">
								<textarea class="input-wrap" name="CONTENTS" id="content">${questions_details.CONTENTS}</textarea>
							</td>
						</tr>
					</tbody>
				</table>
