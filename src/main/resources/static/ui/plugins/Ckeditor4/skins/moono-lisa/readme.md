...
- **mngMenu.css**: the file contains styles of all editor menus including context mngMenu and button drop-down,
it's not loaded until the first mngMenu open up,
